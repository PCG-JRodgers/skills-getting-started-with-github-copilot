...
activities = {
    ...
    "Basketball Club": {
        "description": "Basketball practice focused on skills, teamwork, and game strategy",
    ...
    "Science Olympiad": {
        "description": "Compete in science challenges covering biology, chemistry, and physics",
